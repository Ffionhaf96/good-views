from sqlalchemy import Column, Integer, String, ForeignKey, Table, Float, DateTime, Enum
...
list_contents_table = Table('list_contents', Base.metadata,
...
class Content(Base):
    ...
    content_type = Column(Enum('movie', 'tv', 'episode'), nullable=False)
